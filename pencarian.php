...
<div class="container-fluid" id="content-pencarian" >
  <div class="container">
    ...
    <center>
      	<ul style="width:80vw; margin-left: 2vw; margin-top: 1vh;">
	      <?php 
	        if(isset($keyword)){
	          if($keyword == ''){
	            echo '
	                    ...
	                    <div class="overlay" id="'.$arrayCari['idProduk'].'">
	                      ...
	                      <div class="keterangan">
	                        <div class="container">
	                          ...
	                          <h5 class="ukur">Garansi  &nbsp;: '.$arrayCari['garansi'].'</h5>
	                          <h5 class="ukur">Tersedia : '.$arrayCari['stock'].' Unit</h5>
	                ';
	                if(isset($_SESSION['idUser'])){
	                  echo '
	                    <a href="proses/beli.php?idProduk='.$arrayCari['idProduk'].'&idUser='.$iduser.'" style="margin-left:4vw;"><button type="button" class="btn btn-info">Masukkan Keranjang</button></a>
	                  ';
	                }else{
	                  echo '
