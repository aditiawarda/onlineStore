    ...
    <ul class="nav navbar-nav navbar-right" >
      ...
      <?php 
        ...
        if(isset($_SESSION['idUser'])){
          ...
          echo '
            <a class="not-active" href="#" data-toggle="tooltip" data-placement="bottom" title="Cek Troli"  ><i class="glyphicon glyphicon-shopping-cart" id="trolly"></i></a>
          ';
        }
       ?>
      </li>  
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-3">
        <a href="home.php"><img style="width:12vw; height:7vh; padding-top:2vh; margin-left: 4vw;" alt="Brand" src="asset/img/Brand1.png"></a>
    </div>
    <div class="col-xs-7">
